...
class PatrolReportService:
    ...
    def add_report(start_time, end_time, report_type, routes_id):
        return PatrolReportDAO.add_report(start_time, end_time, report_type, routes_id)
    ...
    def update_report(report_id, start_time, end_time, report_type, routes_id):
        return PatrolReportDAO.update_report(report_id, start_time, end_time, report_type, routes_id)
